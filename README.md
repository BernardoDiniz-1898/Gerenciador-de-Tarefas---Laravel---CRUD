...
Configurando a Migration (database/migrations/...create_tarefas_table.php)
...
Bash
php artisan migrate
Configurando o Model (app/Models/Tarefa.php)
...
Importante: Sempre importe a Facade correta no topo dos controllers:

PHP
use Illuminate\Support\Facades\Auth; // <-- Cuidado com erros de digitação (Illuminate tem dois Ls!)
