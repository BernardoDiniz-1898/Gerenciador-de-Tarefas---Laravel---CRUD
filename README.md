...
O Gemini disse
Aqui está o seu guia formatado, com as marcações de código corrigidas e a hierarquia organizada para ficar perfeito na visualização e fácil de copiar e colar.
...
roubleshooting (Resolução de Problemas Comuns)
